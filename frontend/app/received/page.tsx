...
export default function ReceivedChallengesPage() {
  ...
  const { data: challenges, isLoading } = useUserChallenges("received");
    ...
    return (
      <div className="flex flex-col items-center justify-center p-12 text-center rounded-3xl border border-slate-800 bg-slate-900/50">
        ...
        <p className="text-sm text-slate-400 max-w-md mb-6">
          Connect your Stellar wallet to view challenges sent to your address.
        </p>
  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center gap-3 border-b border-slate-800 pb-4">
        ...
        <div>
          <h1 className="text-2xl font-bold text-white">Received Challenges</h1>
          <p className="text-xs text-slate-400">Challenges and invitations assigned to your Stellar address.</p>
        </div>
      </div>
      ...
      <ChallengeList
        ...
        isLoading={isLoading}
        emptyTitle="No Received Challenges"
        emptyDescription="You haven't received any challenge invitations yet."
      />
    </div>
  );
}
