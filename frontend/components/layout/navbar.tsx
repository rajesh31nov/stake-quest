...
import { Trophy, PlusCircle, Inbox, Send, UserCheck, Activity, History, BarChart3, Settings } from "lucide-react";
      ...
      <header className="sticky top-0 z-50 border-b border-slate-800/80 bg-slate-950/80 backdrop-blur-xl">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-20 flex items-center justify-between">
          ...
          <nav className="hidden xl:flex items-center gap-5 text-xs font-semibold text-slate-300">
            ...
            <Link href="/analytics" className="hover:text-amber-400 transition-colors flex items-center gap-1.5">
              <BarChart3 className="w-3.5 h-3.5 text-amber-400" />
              Analytics
            </Link>
            <Link href="/settings" className="hover:text-amber-400 transition-colors flex items-center gap-1.5">
